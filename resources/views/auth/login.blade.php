                ...
                <div class="row justify-content-center no-gutters vertical-align">
                    <div class="col-lg-4 col-md-6 login-fancy-bg bg"
                        ...
                        <div class="login-fancy">
                            <h2 class="text-white mb-20">Madar Group</h2>
                            <p class="mb-20 text-white">IT Team - Administrator</p>
                            <ul class="list-unstyled  pos-bot pb-30">
                                <li class="list-inline-item"><a class="text-white" href="#"> عند مواجهة المشاكل
                                        أتصل بنا</a> </li>
                                <li class="list-inline-item"><a class="text-white" href="#">236 - 175</a></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="login-fancy pb-40 clearfix">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="section-field mb-20">
                                    <label class="mb-10" for="name">أسم المستخدم*</label>
